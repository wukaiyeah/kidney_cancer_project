...
def crop_image(file_dir, cf):
    ...
    new_image = image_padding(new_image, cf)
...
if __name__ == '__main__':
    ...
    cf = config()
    cf.crop_size = [24,24,24]
    image_source_dir = '/share/service04/wukai/CT_image/testset/images_normalized'
    cf.cropped_dir = '/share/service04/wukai/CT_image/testset/images_cropped_tumor'
