...
shap_table <- read.csv('xgboost_stage_shap_values.csv', sep = ',', header = TRUE)
...
ggplot(data = shap_mean_table, 
  ...
  coord_flip()
ggsave("stage_cls_shap_values_mean.jpg", device = "jpeg", width = 16, height = 12, dpi = 300)
ggsave("stage_cls_shap_values_mean.pdf", device = "pdf", width = 16, height = 12, dpi = 300)
