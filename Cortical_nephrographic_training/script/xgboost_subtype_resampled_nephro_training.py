...
if __name__ == '__main__':
    ...
    model = XGBClassifier(scale_pos_weight = 1.2, # the best 1.2
                        min_child_weight = 1,
                        #learning_rate = 0.01,
                        n_estimators=300,
                        num_boost_round = 300,
    ...
    test_pred_table.to_csv('subtype_proba_nephro_pred_cort.csv', index=0)
