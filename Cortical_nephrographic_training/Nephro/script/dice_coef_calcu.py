...
if __name__ == '__main__':
    base_dir = '/media/wukai/Data01/RCC_classification/kidney_cancer_project/Cortical_nephrographic_training/Nephro'
    true_labels_dir = '/media/wukai/Data01/nnUNet_raw_data_base/nnUNet_raw_data/Task108_KidneyPhase3/labelsTs'
    pred_labels_dir = '/media/wukai/Data01/nnUNet_raw_data_base/nnUNet_raw_data/Task108_KidneyPhase3/labelsTrp_phase3'
    ...
    dice_coeff_result.to_csv(os.path.join(base_dir, 'nephro_model_pred_nephro_set_dice_results.csv'),sep = ',', index = False)
    print('ok')
